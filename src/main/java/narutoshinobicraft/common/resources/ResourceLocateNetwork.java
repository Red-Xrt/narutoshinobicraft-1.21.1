...
public class ResourceLocateNetwork {
    public static final ResourceLocation sync_ninja_data = ResourceLocation.fromNamespaceAndPath(NarutoShinobiCraft.MODID, "sync_ninja_data");
